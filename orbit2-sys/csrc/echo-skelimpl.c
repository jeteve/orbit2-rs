...
#if !defined(_typedef_impl_POA_Echo_)
#define _typedef_impl_POA_Echo_ 1
typedef struct {
POA_Echo servant;
...
#if !defined(_decl_impl_Echo__destroy_)
#define _decl_impl_Echo__destroy_ 1
static void impl_Echo__destroy(impl_POA_Echo *servant,
CORBA_Environment *ev);
#endif

#if !defined(_decl_impl_Echo_echoString_)
#define _decl_impl_Echo_echoString_ 1
static void
...
#if !defined(_impl_Echo_base_epv_)
#define _impl_Echo_base_epv_ 1
...
#if !defined(_impl_Echo_epv_)
#define _impl_Echo_epv_ 1
...
#if !defined(_impl_Echo_vepv_)
#define _impl_Echo_vepv_ 1
...
#if !defined(_impl_Echo__create_)
#define _impl_Echo__create_ 1
...
#if !defined(_impl_Echo__destroy_)
#define _impl_Echo__destroy_ 1
static void
...
#if !defined(_impl_Echo_echoString_)
#define _impl_Echo_echoString_ 1
static void
impl_Echo_echoString(impl_POA_Echo *servant,
const CORBA_char * input,
CORBA_Environment *ev)
